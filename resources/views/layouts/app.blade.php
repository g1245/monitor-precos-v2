            ...
            <div class="flex items-center justify-between py-3">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="text-white text-sm">
                        <div class="flex items-center space-x-1 cursor-pointer hover:text-yellow-300 transition-colors">
            ...
            <div class="flex items-center justify-between py-3">
                ...
                <div class="flex items-center space-x-8">
                    <div class="relative group">
                        <button class="flex items-center space-x-2 px-4 py-2 bg-blue-600 rounded hover:bg-blue-700 transition-colors">

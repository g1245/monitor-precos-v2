...
// Schedule command to sync top discounted products to Department 1 every six hours
Schedule::command('app:sync-top-discounted-products-to-department')->everySixHours();

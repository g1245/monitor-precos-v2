    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <nav class="mb-6 overflow-x-auto">
            <ol class="flex items-center space-x-2 text-sm text-gray-600 whitespace-nowrap">
                ...
                <li class="flex items-center">
                    ...
                    <a href="{{ route('store.show', ['slug' => $store->getSlug(), 'id' => $store->id]) }}" class="hover:text-primary transition-colors">{{ $store->name }}</a>
                </li>
                <li class="flex items-center">
                    <svg class="w-4 h-4 mx-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span class="text-gray-900">Todos os produtos</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center">
                <h1 class="text-3xl font-bold text-gray-800">Todos os produtos de {{ $store->name }}</h1>

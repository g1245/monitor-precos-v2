            ...
            <div class="lg:col-span-1 space-y-6 order-first lg:order-last">
                ...
                <div class="lg:hidden bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="flex space-x-2">
                        <button class="flex-1 action-button-secondary flex items-center justify-center space-x-2 text-gray-700 py-2 px-4 rounded-lg transition-colors text-sm cursor-pointer" data-action="copy-link">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                            </svg>
                            <span>Copiar link</span>
                        </button>
                        <a href="{{ route('product.share.whatsapp', $product->id) }}" target="_blank" class="flex-1 action-button-secondary flex items-center justify-center space-x-2 text-gray-700 py-2 px-4 rounded-lg transition-colors text-sm cursor-pointer">
